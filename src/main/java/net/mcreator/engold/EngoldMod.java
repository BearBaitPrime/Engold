...
public class EngoldMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(EngoldMod.class);
	public static final String MODID = "engold";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing EngoldMod");
		EngoldModTabs.load();
