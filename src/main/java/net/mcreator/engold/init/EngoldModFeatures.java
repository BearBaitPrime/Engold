...
public class EngoldModFeatures {
	public static void load() {
		...
		register("mass_coal_clump", new OreFeature(OreConfiguration.CODEC), MassCoalClumpBlock.GENERATE_BIOMES, GenerationStep.Decoration.UNDERGROUND_ORES);
		register("sap_block", new OreFeature(OreConfiguration.CODEC), SapBlockBlock.GENERATE_BIOMES, GenerationStep.Decoration.UNDERGROUND_ORES);
	}
